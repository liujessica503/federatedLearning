...
source activate fedModelSetup (already ran conda create -n fedModelSetup and conda install tensorflow==1.14.0 and activated fedModelSetup and conda install matplotlib)
