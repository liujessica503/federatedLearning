...
class BaseModel(ABC):
    ...
    def evaluate(self, user_model: Any, test_covariates: Any, test_labels: Any, predictions: List[int], plotAUC = False, globalModel = False) -> dict():
        # get more metrics
        ...
        metrics = {"Number of Test Obs": test_labels.shape[0], "FPR": fpr, "TPR": tpr, "AUC": auc_value, 'Score': score, 'Precision': precision, 'Recall': recall, 'F1': f1, 'Cohen': cohen}
        return metrics
